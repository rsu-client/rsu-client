...
Q:	CansIsforce the rsu-query to use the faster perl script version if i
...
A:	No, perl is very easy to code in andsIscan do several things easier than on other
